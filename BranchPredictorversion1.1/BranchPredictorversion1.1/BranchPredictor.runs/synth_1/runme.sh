...
HD_PWD='D:/sem5/DSD/groupProject/BranchPredictorversion2/BranchPredictor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BranchPredictor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BranchPredictor.tcl
