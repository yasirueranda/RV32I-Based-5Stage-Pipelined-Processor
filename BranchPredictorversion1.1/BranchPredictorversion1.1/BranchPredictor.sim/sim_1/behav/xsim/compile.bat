...
REM
REM Generated by Vivado on Sat Dec 30 09:48:15 +0530 2023
...
echo "xvlog --incr --relax -prj BranchPredictTB_vlog.prj"
call xvlog  --incr --relax -prj BranchPredictTB_vlog.prj -log xvlog.log
