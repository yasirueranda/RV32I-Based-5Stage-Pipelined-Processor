...
HD_PWD='D:/sem5/DSD/groupProject/BranchPredictorversion1/BranchPredictor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BranchPredictor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BranchPredictor.tcl -notrace
